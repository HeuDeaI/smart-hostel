    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => {
            return (
              <Icon source={"office-building-cog"} size={size} color={color} />
            );
          },
        }}
      />
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => {
            return <Icon source={"comment-plus"} size={size} color={color} />;
          },
        }}
      />
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => {
            return <Icon source={"clock-check"} size={size} color={color} />;
          },
        }}
      />
      <Drawer.Screen
