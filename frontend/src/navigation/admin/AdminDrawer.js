...
import CleaningRequests from "../../screens/app/admin/CleaningRequests";
import AdminOrders from "../../screens/app/admin/AdminOrders";
...
export const AdminDashboard = () => {
  return (
    ...
    >
      ...
      />
      <DashboardStack.Screen
        name="AdminCleaningRequests"
        component={CleaningRequests}
        options={{
          headerShown: true,
          title: "Запросы на уборку",
        }}
      />
      <DashboardStack.Screen
        name="AdminOrders"
